...
edit_dpdk_config CONFIG_RTE_LIBRTE_PMD_PCAP=y $NEWCONFIG
...
${MAKE} T=${NEW_TARGET} config && ${MAKE} -j12 ROOTDIRS-y="buildtools lib drivers" CONFIG_RTE_KNI_KMOD=n CONFIG_RTE_EAL_IGB_UIO=n
